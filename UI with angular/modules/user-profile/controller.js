...
$scope.updateUser = function(){
    ...
    UserProfileService.updateProfile(org_name, currentUserEmail, $scope.myData.user.firstname,
      $scope.myData.user.lastname, $scope.myData.user.street1, $scope.myData.user.street2,
      $scope.myData.user.city, $scope.myData.user.state, $scope.myData.user.country, $scope.myData.user.zip, $scope.myData.user.aboutme, token, function(response,data){
      //$route.reload();
...
//       UserProfileService.updateData($scope.firstname, $scope.lastname, $scope.email, $scope.password, $scope.phone){
//
//       }
// }
}]);
